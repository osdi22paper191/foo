...
void ipv4_1() {
  ...
  R3S_packet_t p;
  R3S_key_t k = { 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  R3S_ipv4_t ipv4_src = { 13, 168, 1, 25 };
...
void ipv4_tcp_1() {
  ...
  R3S_key_hash_out_t o;
  R3S_packet_t p;
  R3S_key_t k = { 0x6d, 0x5a, 0x56, 0xda, 0x25, 0x5b, 0x0e, 0xc2, 0x41,
...
void ipv6_tcp_1() {
  ...
  R3S_ipv6_t ipv6_src = { 0x3f, 0xfe, 0x25, 0x01, 0x02, 0x00, 0x1f, 0xff,
                          0,    0,    0,    0,    0,    0,    0,    7 };
  R3S_ipv6_t ipv6_dst = { 0x3f, 0xfe, 0x25, 0x01, 0x02, 0x00, 0x00, 0x03,
                          0,    0,    0,    0,    0,    0,    0,    1 };
