...
BUILD_DIR = f"{SYNTHESIZED_DIR}/build/foo"
...
EXTRA_VAR_MAKEFILE = f"{os.getcwd()}/Makefile.foo"
...
def build_foo():
  subprocess.call([ "make", "foo" ], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)

def clean_foo():
  subprocess.call([ "make", "clean-foo" ], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
